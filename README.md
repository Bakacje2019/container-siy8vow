...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-siy8vow.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-siy8vow.containers.anotherwebservice.com/
...
```
git clone git@github.com:Bakacje2019/container-siy8vow.git
cd container-siy8vow
```
...
```
docker attach container-siy8vow
```
